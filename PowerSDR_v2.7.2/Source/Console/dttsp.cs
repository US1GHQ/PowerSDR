...
namespace PowerSDR
{
	unsafe class DttSP
	{
        ...
        [DllImport("DttSP.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetDSPBuflen")]
...
//		public static extern void AudioReset();
        ...
        [DllImport("DttSP.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Audio_Callback2")]
        ...
        [DllImport("DttSP.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Process_Panadapter")]
